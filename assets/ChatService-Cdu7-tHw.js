import"./vendor-CxYr4mm8.js";import"./index-CNJv9rvb.js";import"./auth-BXStSppl.js";import"./caption-parsing-xgVrukzZ.js";import"./locales-7xY_oabk.js";import"./Icons-CAlIRLcW.js";import"./language-db-BawjwMwG.js";import"./react-dom-DFvZlirb.js";import"./hls-xeo-W7rp.js";const m="https://gemini.aether.mom/v1beta/models/gemini-2.5-flash-lite:streamGenerateContent";async function x(i){var r,o,s,n,a;try{const e=await fetch(m.replace("streamGenerateContent","generateContent"),{method:"POST",headers:{"x-goog-api-key":"limon87","Content-Type":"application/json"},body:JSON.stringify({contents:[{parts:[{text:`You are an AI specialized exclusively in recommending movies and TV shows.
